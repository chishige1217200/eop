...
\subsection{\texttt{strcmp()}関数で数値の大小を比較するプログラム}\label{funccmp}
プログラムのソースコード(17行)
\begin{Verbatim}[fontsize=\small, baselinestretch=0.8]
     1	#include <stdio.h>
     2	#include <string.h>
...
\%83\%B3\%E3\%83\%97.html，2020．5．22．%'%'はLaTeXの特殊文字にあたるため，\を挿入している．
  ...
  \bibitem{www:label11} 【C言語入門】文字列を比較する方法（strcmp、strncmp），https://www.sejuku.net/blog/25303，2020．07．23
